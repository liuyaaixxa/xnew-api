...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.GET("/affiliate/invite", controller.GetInvitePage)
		apiRouter.GET("/pricing", middleware.TryUserAuth(), controller.GetPricing)
			apiRouter.GET("/flash-sale", controller.GetFlashSaleInfo)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/topup", middleware.CriticalRateLimit(), controller.TopUp)
					selfRoute.POST("/flash-sale/grab", middleware.CriticalRateLimit(), controller.GrabFlashSale)
					selfRoute.GET("/flash-sale/my", controller.GetMyGrabedCoupons)
					selfRoute.POST("/flash-sale/activate", middleware.CriticalRateLimit(), controller.ActivateGrabedCoupon)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/topup/pending-review", controller.GetPendingReviewTopUps)
				adminRoute.POST("/topup/approve", controller.ApprovePendingReviewTopUp)
				adminRoute.POST("/topup/reject", controller.RejectPendingReviewTopUp)
		...
		redemptionRoute.Use(middleware.AdminAuth())
		{
			...
			redemptionRoute.GET("/stats", controller.GetRedemptionStats)
